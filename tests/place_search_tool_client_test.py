#!/usr/bin/env python3
"""
Place Search Tool Test with JWT Authentication
"""
import requests
import sys
import os
...
def main():
    print("=" * 60)
    print("Place Search Tool Test with JWT Authentication")
    print("=" * 60)
    ...
    try:
        ...
        if response.status_code == 200:
            print("✅ Place Search Tool test successful!")
            print("\nResponse JSON:")
            import json
